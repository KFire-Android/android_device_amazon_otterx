...
public class Utils {
    private static final String TAG = "OtterParts_Utils";
    private static final String TAG_READ = "OtterParts_Utils_Read";
    private static final String TAG_WRITE = "OtterParts_Utils_Write";
